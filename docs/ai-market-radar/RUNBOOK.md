...
```cron
0 * * * * cd "<путь-к-репозиторию>" && python -m ai_market_radar.cli ingest
10 * * * * cd "<путь-к-репозиторию>" && python -m ai_market_radar.cli detect
20 * * * * cd "<путь-к-репозиторию>" && python -m ai_market_radar.cli pipeline
0 2 * * * cd "<путь-к-репозиторию>" && python -m ai_market_radar.cli expire
0 8 * * * cd "<путь-к-репозиторию>" && python -m ai_market_radar.cli report
```
