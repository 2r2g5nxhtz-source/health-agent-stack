# Legacy AI Deals Monitor MVP

> Warning: this document describes an older AI Deals Monitor stack, not the current Health Agent iPhone app. Do not use it as the deployment guide for Apple Health ingestion.
